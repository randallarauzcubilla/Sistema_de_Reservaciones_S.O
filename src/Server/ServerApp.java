...
/**
 * Main application class for the server. Manages shared resources and
 * initializes the synchronization manager.
 */
public class ServerApp {

    /**
     * Base synchronization manager for all locks. Parameters: capacity=200,
     * projectors=3, microphones=5, sound=2.
     */
    ...
    /**
     * Application entry point. Sets the UI Look and Feel and opens the server
     * window.
     *
