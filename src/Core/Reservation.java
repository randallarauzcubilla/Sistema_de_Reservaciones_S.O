...
public class Reservation {
    ...
    public enum Estado {
        LIBRE, RESERVADO_TEMPORAL, CONFIRMADO, CANCELADO
    }
    ...
    public Reservation(String idCliente, String fecha, String horaInicio,
    ...
    public long segundosRestantes() {
        if (estado != Estado.RESERVADO_TEMPORAL) return -1;
