...
/**
 * Validates if an ID belongs to a privileged role (PROFESSOR or DEANERY) by
 * reading the professors.txt and deans.txt files.
 *
 * File format: one ID per line, no spaces. Location: project root (where the
 * server runs).
 */
public class RoleValidator {
    ...
    /**
     * Loads the role files into memory once. Synchronized to ensure thread-safe
     * initialization.
     */
     ...
     * STUDENT: Always permitted. PROFESSOR: ID must exist in professors.txt.
